					...
					<aside class="w-64 pt-8">
						<div class="mb-10">
							...
							<ul class="list-reset">
								...
								<li class="text-sm leading-loose"><router-link class="text-black" to="/colours">Colours</router-link></li>
						...
						<div>
							...
							<ul class="list-reset">
								...
								<li class="text-sm leading-loose"><router-link class="text-black" to="/loaders">Loaders and Animations</router-link></li>
